...
export const AddBookCard = () => {
  ...
  return alertShow ? (
    <div>
      <Alert icon={<CheckIcon fontSize="inherit" />} severity={alertStatus}>
        {alertMessage}
      </Alert>
      <MyBookList />
    </div>
      ...
      <Card>
        ...
        >
          ...
          <TextField
            sx={{ paddingBottom: 2 }}
            type="number"
            placeholder="Published date (yyyy)"
            name="book_publishedDate"
            aria-label="Published date (yyyy)"
            role="textbox"
